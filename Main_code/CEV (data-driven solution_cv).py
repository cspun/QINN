...
class BSINN:
    ...
    def __init__(self, X_1, X_test, u, u_test,
        ...
        self.sigma = tf.constant([1.83], dtype=tf.float32)
        self.gamma = tf.constant([0.8], dtype=tf.float32)
        ...
        for n in num_neurons:
            ...
            for i in range(k):
                ...
                for alpha in np.linspace(0.,1.,5):
                    ...
                    for j in range(4):
                        ...
                        model = BSINN(X_u_train_1_s, X_u_test_1_s, u_train_s, u_test_s, 
                                      X_f_train_1_s, X_f_test_1_s, uf_train_s, uf_test_s, Kf_train_s,
                ...
                CEV_data = {'X_u_test_1':X_u_test_1, 'u_test_pred':u_test_pred, 'u_test_tot':u_test_tot, 
                              'K_test_tot':K_test_tot,'alpha':alpha_opt, 'sigma': sigma, 'gamma': gamma}
                filename = 'CEV_%d_l_%d_n_%d_fold_variable_fitsolver_rep_1_revised'%(l,n,i+1)
