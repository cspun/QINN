        ...
        for n in num_neurons:
            ...
            for alpha in np.linspace(0,1,5):
                ...
                for i in range(k):
                    ...
                    BS_data = {'X_u_test_1':X_u_test_1, 'u_test_pred':u_test_pred, 'u_test_tot':u_test_tot, 'K_test_tot':K_test_tot,
                               'alpha':alpha}
                    filename = 'BS_%d_l_%d_n_%d_fold_nn_fitsolver_alpha_%d_rep'%(l,n,i+1,c)
