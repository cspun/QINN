...
class BSINNsquared:
    ...
    def __init__(self, X_1, X_test, u, u_test, 
        ...
        #self.thetaClipped = tf.clip_by_value(self.theta, 0, 1)
        #self.epsilonClipped = tf.clip_by_value(self.epsilon, 0, 1)
        #self.rhoClipped = tf.clip_by_value(self.rho, -1, 1)
        ...
        self.loss = self.alpha*tf.reduce_mean(tf.square(self.u_tf - self.u_pred)) + \
                    ...
                    #tf.reduce_mean(tf.square(self.rho - self.rhoClipped))
        ...
        for n in num_neurons:
            ...
            for alpha in np.linspace(0,1,5):
                ...
                for i in range(k):
                    ...
                    filename = 'GARCH_%d_l_%d_n_%d_fold_nn_fitsolver_alpha_%d_rep_v(with_train)'%(l,n,i+1,c)
