...
if __name__ == "__main__": 
    ...
    # Train/test data
    infile = open('../train_test data/Three_half_4_folds_data_v_5000','rb')
    ...
    infile = open('../train_test data/Three_half_4_folds_data_s_v_5000','rb')
    data = pickle.load(infile)
    infile.close()
    ...
    for l in num_layers:
        for n in num_neurons:
            ...
            for i in range(k):
                ...
                filename = 'Three_half_%d_l_%d_n_%d_fold_nn_fitsolver_rep_v(with_train)'%(l,n,i+1)
